...
# Do you want to use the admin panel?? (Under progress..)
...
```
You can then inject this admin account into the database by using a tool such as `DB browser`. Now you can access the admin panel with an admin account! 